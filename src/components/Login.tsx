        ...
        <div className="w-1/2 flex justify-center items-center">
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-lg w-full">
            ...
            <div className="text-center mt-6">
              <p className="text-md">Or you can join with</p>
              <div className="flex justify-center mt-4 space-x-4">
                <button className="bg-gray-200 rounded-full p-3 w-12 h-12 text-xl font-bold">G</button>
                <button className="bg-gray-200 rounded-full p-3 w-12 h-12 text-xl font-bold">F</button>
                <button className="bg-gray-200 rounded-full p-3 w-12 h-12 text-xl font-bold">A</button>
              </div>
            </div>
          </div>
        </div>
